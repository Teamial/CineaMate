...
def fix_recommendation_events_schema():
    ...
    try:
        ...
        from .migrate_recommendation_events import migrate_recommendation_events
        
        success = migrate_recommendation_events()
        
        if success:
            return {"status": "success", "message": "Schema migration completed successfully"}
        else:
            return {"status": "error", "message": "Schema migration failed"}
