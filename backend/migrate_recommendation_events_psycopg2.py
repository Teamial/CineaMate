#!/usr/bin/env python3
"""
Database migration using psycopg2 directly
...
def migrate_recommendation_events():
    ...
    try:
        cursor = conn.cursor()
        logger.info("🔧 Migrating recommendation_events table using psycopg2...")
        ...
        for column_name, column_type in columns_to_add:
            if not check_column_exists(cursor, 'recommendation_events', column_name):
